...
<section class="tour-hero">
  ...
  <div class="tour-hero__content">
    ...
    <div class="tour-hero__actions">
      ...
      <a href="https://wa.me/8613799412007?text=Hi%20TibetRide%2C%20I%20am%20interested%20in%20the%20{name.replace(' ', '%20')}" class="btn btn--outline btn--lg" target="_blank" rel="noopener" data-lang-zh="WhatsApp咨询" data-lang-en="Chat on WhatsApp">Chat on WhatsApp</a>
    </div>
  </div>
</section>
